...
function cr() {
  ...
  function T(E, d, w) {
    var m, R = {}, O = null, $ = null;
    w !== void 0 && (O = "" + w), d.key !== void 0 && (O = "" + d.key), d.ref !== void 0 && ($ = d.ref);
    for (m in d)
...
const pr = (s) => {
  const c = vr(s), b = () => {
    ...
    c.state === "blocked" && setTimeout(c.proceed, 0);
  };
  return {
    isActive: c.state === "blocked",
    onConfirm: g,
    resetConfirmation: b
  };
};
function gr({
  ...
  return S ? /* @__PURE__ */ X.jsx("div", { children: c({
    isActive: !0,
    onConfirm: E,
    onCancel: d
  }) }) : null;
